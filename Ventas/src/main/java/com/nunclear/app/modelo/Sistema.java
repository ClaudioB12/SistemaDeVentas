...
import com.nunclear.app.gui.Grafico;
...
public final class Sistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEliminarventa.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        ...
        txtIdCV.setBackground(new java.awt.Color(204, 204, 204));
        ...
        jPanel2.add(btnGraficar, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 110, -1, -1));
        ...
        jPanel2.add(btnRepPost, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 70, 130, 30));
        ...
        jPanel11Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel11Layout.createSequentialGroup()
                ...
                .addGroup(jPanel11Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addComponent(btnGuardarpro, javax.swing.GroupLayout.PREFERRED_SIZE, 98, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(btnEditarpro))
                    .addGroup(jPanel11Layout.createSequentialGroup()
                        .addComponent(btnEliminarPro, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        jPanel6.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 40, 160, -1));
        ...
        btnActualizarConfig.setBackground(new java.awt.Color(102, 102, 102));
    ...
    private void runReport2() {
        try {
            ...
            JasperDesign jdesign = JRXmlLoader.load(getFile("reporttablaventa.jrxml"));
    ...
    private void runReport1() {
        try {
            ConnS instance = ConnS.getInstance();
            HashMap param = new HashMap();
            JasperDesign jdesign = JRXmlLoader.load(getFile("factura.jrxml"));
            JasperReport jreport = JasperCompileManager.compileReport(jdesign);
            JasperPrint jprint = JasperFillManager.fillReport(jreport, param, instance.getConnection());
            JasperViewer.viewReport(jprint, false);
